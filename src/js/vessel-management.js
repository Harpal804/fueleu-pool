...
export default class VesselManager {
    ...
    // Update the loadSampleData() method in vessel-management.js
    loadSampleData() {
        this.vessels = [
            {
                id: 1,
